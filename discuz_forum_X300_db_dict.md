...
| isblank | tinyint(1) |   | NO |   | 是否为空白模块，只显示准送数据 |
...
| icondowntime | int(10) unsigned |   | NO |   | 应用图标下载到本地时间 |
...
| allowbegincode | tinyint(1) unsigned |   | NO |   | 允许使用开头动画代码 |
...
| forcesecques | tinyint(1) unsigned |   | NO |   | 强制设置安全提问才能进入后台管理 |
| closead | tinyint(1) unsigned |   | NO |   | 是否展示广告 |
| buildgroupcredits | smallint(6) unsigned |   | NO |   | 创建群组需要消耗的积分 |
| allowimgcontent | tinyint(1) unsigned |   | NO |   | 允许主题内容生成图片 |

## pre_common_visit  用户访问日志表

| 字段名 | 数据类型 | 默认值 | 允许非空 | 自动递增 | 备注 |
| ------ | -------- | ------ | -------- | -------- | ---- |
| ip | int(10) unsigned |   | NO |   | 用户IP |
| view | int(10) unsigned |   | NO |   | 访问次数 |
...
| find | varchar(255) |   | NO |   | 不良词语 |
| replacement | varchar(255) |   | NO |   | 替换内容 |
...
| 字段名 | 数据类型 | 默认值 | 允许非空 | 自动递增 | 备注 |
| ------ | -------- | ------ | -------- | -------- | ---- |
| id | smallint(6) unsigned |   | NO | 是 | 词语过滤分类id |
| typename | varchar(15) |   | NO |   | 分类名称 |
...
| uid | mediumint(8) unsigned |   | NO |   | 会员id |
| fid | mediumint(8) unsigned |   | NO |   | 论坛id |
| allowview | tinyint(1) |   | NO |   | 允许浏览 |
| allowpost | tinyint(1) |   | NO |   | 允许发表 |
| allowreply | tinyint(1) |   | NO |   | 允许回复 |
| allowgetattach | tinyint(1) |   | NO |   | 允许下载附件 |
| allowgetimage | tinyint(1) |   | NO |   | 允许查看图片 |
| allowpostattach | tinyint(1) |   | NO |   | 允许上传附件 |
| allowpostimage | tinyint(1) |   | NO |   | 允许上传图片 |
| adminuser | mediumint(8) unsigned |   | NO |   | 管理员id |
| dateline | int(10) unsigned |   | NO |   | 时间 |
...
| tid | mediumint(8) unsigned |   | NO |   | 主题id |
| uid | mediumint(8) unsigned |   | NO |   | 会员id |
| aid | mediumint(8) unsigned |   | NO |   | 主题图片id |
| cost | mediumint(8) unsigned |   | NO |   | 每人花销 |
| starttimefrom | int(10) unsigned |   | NO |   | 开始时间 |
| starttimeto | int(10) unsigned |   | NO |   | 结束时间 |
| place | varchar(255) |   | NO |   | 地点 |
| class | varchar(255) |   | NO |   | 类别 |
| gender | tinyint(1) |   | NO |   | 性别 |
| number | smallint(5) unsigned |   | NO |   | 人数 |
| applynumber | smallint(5) unsigned |   | NO |   | 已参加人数 |
| expiration | int(10) unsigned |   | NO |   | 报名截止日期 |
| ufield | text |   | NO |   | 用户定制项目 |
| credit | smallint(6) unsigned |   | NO |   | 需消耗的积分 |

## pre_forum_activityapply  活动申请表

| 字段名 | 数据类型 | 默认值 | 允许非空 | 自动递增 | 备注 |
| ------ | -------- | ------ | -------- | -------- | ---- |
| applyid | int(10) unsigned |   | NO | 是 | 申请id |
| tid | mediumint(8) unsigned |   | NO |   | 主题id |
| username | varchar(255) |   | NO |   | 用户名 |
| uid | mediumint(8) unsigned |   | NO |   | 会员id |
| message | varchar(255) |   | NO |   | 消息 |
| verified | tinyint(1) |   | NO |   | 是否审核通过
        (0:N 1:Y 2:需完善资料) |
| dateline | int(10) unsigned |   | NO |   | 申请时间 |
| payment | mediumint(8) |   | NO |   | 每人花销 |
| ufielddata | text |   | NO |   | 用户定制项目数据 |

## pre_forum_announcement  公告表

| 字段名 | 数据类型 | 默认值 | 允许非空 | 自动递增 | 备注 |
| ------ | -------- | ------ | -------- | -------- | ---- |
| id | smallint(6) unsigned |   | NO | 是 | 公告id |
| author | varchar(15) |   | NO |   | 作者姓名 |
| subject | varchar(255) |   | NO |   | 公告标题 |
| type | tinyint(1) |   | NO |   | 公告类型
        (0:文字公告 1:网址链接) |
| displayorder | tinyint(3) |   | NO |   | 显示顺序 |
| starttime | int(10) unsigned |   | NO |   | 开始时间 |
| endtime | int(10) unsigned |   | NO |   | 结束时间 |
| message | text |   | NO |   | 消息 |
| groups | text |   | NO |   | 接受用户组 |
...
| uid | mediumint(8) unsigned |   | NO |   | 会员id |
| tableid | tinyint(1) unsigned |   | NO |   | 附件表id |
| downloads | mediumint(8) |   | NO |   | 下载次数 |
...
| pid | int(10) unsigned |   | NO |   | 帖子id |
| uid | mediumint(8) unsigned |   | NO |   | 会员id |
| dateline | int(10) unsigned |   | NO |   | 上传时间 |
| filename | varchar(255) |   | NO |   | 原文件名 |
| filesize | int(10) unsigned |   | NO |   | 文件大小 |
| attachment | varchar(255) |   | NO |   | 服务器路径 |
| remote | tinyint(1) unsigned |   | NO |   | 是否远程附件 |
| description | varchar(255) |   | NO |   | 说明 |
| readperm | tinyint(3) unsigned |   | NO |   | 阅读权限 |
| price | smallint(6) unsigned |   | NO |   | 附件价格 |
| isimage | tinyint(1) |   | NO |   | 是否图片 |
| width | smallint(6) unsigned |   | NO |   | 附件宽度 |
| thumb | tinyint(1) unsigned |   | NO |   | 是否是缩率图 |
| picid | mediumint(8) |   | NO |   | 相册图片ID |
...
| 字段名 | 数据类型 | 默认值 | 允许非空 | 自动递增 | 备注 |
| ------ | -------- | ------ | -------- | -------- | ---- |
| id | smallint(6) unsigned |   | NO | 是 | 类型id |
| fid | mediumint(8) unsigned |   | NO |   | 论坛id |
| extension | char(12) |   | NO |   | 扩展名 |
| maxsize | int(10) unsigned |   | NO |   | 允许上传最大值 |

## pre_forum_bbcode  Discuz! 代码表

| 字段名 | 数据类型 | 默认值 | 允许非空 | 自动递增 | 备注 |
| ------ | -------- | ------ | -------- | -------- | ---- |
| id | mediumint(8) unsigned |   | NO | 是 | 代码id |
| available | tinyint(1) |   | NO |   | 是否启用
        (0:不启用 1:启用但不显示 2:启用并显示) |
| tag | varchar(100) |   | NO |   | 标签 |
| icon | varchar(255) |   | NO |   | 图标 |
| replacement | text |   | NO |   | 替换内容 |
| example | varchar(255) |   | NO |   | 例子 |
| explanation | text |   | NO |   | 解释说明 |
| params | tinyint(1) unsigned | 1 | NO |   | 参数个数 |
| prompt | text |   | NO |   | 标签描述 |
| nest | tinyint(3) unsigned | 1 | NO |   | 嵌套层次 |
| displayorder | tinyint(3) |   | NO |   | 显示顺序 |
| perm | text |   | NO |   | 有权使用的用户组 |

## pre_forum_collection  淘帖专辑表

| 字段名 | 数据类型 | 默认值 | 允许非空 | 自动递增 | 备注 |
| ------ | -------- | ------ | -------- | -------- | ---- |
| ctid | mediumint(8) unsigned |   | NO | 是 | 专辑ID |
| uid | mediumint(8) unsigned |   | NO |   | 用户ID |
| username | varchar(15) |   | NO |   | 用户名 |
| name | varchar(50) |   | NO |   | 专辑名 |
| dateline | int(10) unsigned |   | NO |   | 创建时间 |
| follownum | mediumint(8) unsigned |   | NO |   | 订阅数 |
| threadnum | mediumint(8) unsigned |   | NO |   | 主题数 |
| commentnum | mediumint(8) unsigned |   | NO |   | 评论数 |
| desc | varchar(255) |   | NO |   | 简介 |
| lastupdate | int(10) unsigned |   | NO |   | 最后变动时间 |
| rate | float |   | NO |   | 评分 |
| ratenum | mediumint(8) unsigned |   | NO |   | 评分次数 |
| lastpost | mediumint(8) unsigned |   | NO |   | 最后主题ID |
| lastsubject | varchar(80) |   | NO |   | 最后主题标题 |
| lastposttime | int(10) unsigned |   | NO |   | 最后主题时间 |
| lastposter | varchar(15) |   | NO |   | 最后主题发帖者 |
| lastvisit | int(10) unsigned |   | NO |   | 创建者最后访问 |
| keyword | varchar(255) |   | NO |   | 专辑关键词 |

## pre_forum_collectioncomment  淘帖评论表

| 字段名 | 数据类型 | 默认值 | 允许非空 | 自动递增 | 备注 |
| ------ | -------- | ------ | -------- | -------- | ---- |
| cid | mediumint(8) unsigned |   | NO | 是 | 评论ID |
| ctid | mediumint(8) unsigned |   | NO |   | 专辑ID |
| uid | mediumint(8) unsigned |   | NO |   | 用户ID |
| username | varchar(15) |   | NO |   | 用户名 |
| message | text |   | NO |   | 评论内容 |
| dateline | int(10) unsigned |   | NO |   | 评论时间 |
| useip | varchar(16) |   | NO |   | IP地址 |
| rate | float |   | NO |   | 评分 |
...
| username | char(15) |   | NO |   | 用户名 |
| ctid | mediumint(8) unsigned |   | NO |   | 专辑ID |
| dateline | int(10) unsigned |   | NO |   | 关注时间 |
| lastvisit | int(10) unsigned |   | NO |   | 最后访问专辑时间 |
...
| ------ | -------- | ------ | -------- | -------- | ---- |
| ctid | mediumint(8) unsigned |   | NO |   | 专辑ID |
| uid | mediumint(8) unsigned |   | NO |   | 邀请合作者ID |
| dateline | int(10) unsigned |   | NO |   | 邀请时间 |
...
| ------ | -------- | ------ | -------- | -------- | ---- |
| ctid | mediumint(8) unsigned |   | NO |   | 专辑ID |
| uid | mediumint(8) unsigned |   | NO |   | 合作者ID |
| name | varchar(50) |   | NO |   | 专辑名 |
| username | varchar(15) |   | NO |   | 用户名 |
| lastvisit | int(8) unsigned |   | NO |   | 最后访问专辑时间 |
...
| ------ | -------- | ------ | -------- | -------- | ---- |
| ctid | mediumint(8) unsigned |   | NO |   | 专辑ID |
| tid | mediumint(8) unsigned |   | NO |   | 专辑内主题ID |
| dateline | int(10) unsigned |   | NO |   | 主题日期 |
| reason | varchar(255) |   | NO |   | 推荐理由 |
...
| ------ | -------- | ------ | -------- | -------- | ---- |
| uid | mediumint(8) unsigned |   | NO |   | 会员id |
| fromto | char(15) |   | NO |   | 来自/到 |
| sendcredits | tinyint(1) |   | NO |   | 转出积分字段 |
| receivecredits | tinyint(1) |   | NO |   | 接受积分字段 |
| send | int(10) unsigned |   | NO |   | 转出积分 |
| receive | int(10) unsigned |   | NO |   | 接受积分 |
| dateline | int(10) unsigned |   | NO |   | 转帐日期 |
| operation | char(3) |   | NO |   | 操作 |
...
| ------ | -------- | ------ | -------- | -------- | ---- |
| tid | mediumint(8) unsigned |   | NO |   | 主题id |
| uid | mediumint(8) unsigned |   | NO |   | 发起人id |
| starttime | int(10) unsigned |   | NO |   | 开始时间 |
| endtime | int(10) unsigned |   | NO |   | 结束时间 |
| affirmdebaters | mediumint(8) unsigned |   | NO |   | 正方辩论人数 |
| negadebaters | mediumint(8) unsigned |   | NO |   | 反方辩论人数 |
| affirmvotes | mediumint(8) unsigned |   | NO |   | 正方得票数 |
| negavotes | mediumint(8) unsigned |   | NO |   | 反方得票数 |
| umpire | varchar(15) |   | NO |   | 裁判用户名 |
| winner | tinyint(1) |   | NO |   | 获胜方
        (0:平局 1:为正方 2:为反方)
        裁判评判结果 |
| bestdebater | varchar(50) |   | NO |   | 最佳辩手用户名 |
| affirmpoint | text |   | NO |   | 正方观点 |
| negapoint | text |   | NO |   | 反方观点 |
| umpirepoint | text |   | NO |   | 裁判观点，裁判结束辩论时填写 |
| affirmvoterids | text |   | NO |   | 正方投票人的 id 集合 |
| negavoterids | text |   | NO |   | 反方投票人的 id 集合 |
| affirmreplies | mediumint(8) unsigned |   | NO |   | 正方回复次数，用来翻页 |
| negareplies | mediumint(8) unsigned |   | NO |   | 反方回复次数，用来翻页 |
...
| ------ | -------- | ------ | -------- | -------- | ---- |
| pid | int(10) unsigned |   | NO |   | 帖子id |
| stand | tinyint(1) |   | NO |   | 立场
        (0:中立 1:正方 2:为反方) |
| tid | mediumint(8) unsigned |   | NO |   | 主题id |
| uid | mediumint(8) unsigned |   | NO |   | 发起人id |
| dateline | int(10) unsigned |   | NO |   | 发表的时间 |
| voters | mediumint(10) unsigned |   | NO |   | 投票人数 |
| voterids | text |   | NO |   | 投票人的 id 集合 |

## pre_forum_faq  论坛帮助表

| 字段名 | 数据类型 | 默认值 | 允许非空 | 自动递增 | 备注 |
| ------ | -------- | ------ | -------- | -------- | ---- |
| id | smallint(6) |   | NO | 是 | 帮助id |
| fpid | smallint(6) unsigned |   | NO |   | 帮助父id |
| displayorder | tinyint(3) |   | NO |   | 排序 |
| identifier | varchar(20) |   | NO |   | 帮助标识 |
| keyword | varchar(50) |   | NO |   | 帮助关键词 |
| title | varchar(50) |   | NO |   | 帮助标题 |
| message | text |   | NO |   | 帮助内容 |

## pre_forum_filter_post  非水帖标记

| 字段名 | 数据类型 | 默认值 | 允许非空 | 自动递增 | 备注 |
| ------ | -------- | ------ | -------- | -------- | ---- |
| tid | mediumint(8) unsigned |   | NO |   | 主题ID |
| pid | int(10) unsigned |   | NO |   | 帖子ID |
| postlength | int(10) unsigned |   | NO |   | 帖子真实长度 |
...
| fup | mediumint(8) unsigned |   | NO |   | 上级论坛id |
| type | enum('group','forum','sub') | forum | NO |   | 类型
...
| rank | smallint(6) unsigned |   | NO |   | 排名 |
| oldrank | smallint(6) unsigned |   | NO |   | 前天排名 |
| lastpost | char(110) |   | NO |   | 最后发表 |
| domain | char(15) |   | NO |   | 绑定的二级域名 |
| allowsmilies | tinyint(1) |   | NO |   | 允许使用表情 |
| allowhtml | tinyint(1) |   | NO |   | 允许使用html |
| allowbbcode | tinyint(1) |   | NO |   | 允许bbcode |
| allowimgcode | tinyint(1) |   | NO |   | 允许img |
| allowmediacode | tinyint(1) |   | NO |   | 允许使用多媒体代码 |
| allowanonymous | tinyint(1) |   | NO |   | 允许匿名 |
| allowpostspecial | smallint(6) unsigned |   | NO |   | 允许发表特殊主题 |
| allowspecialonly | tinyint(1) unsigned |   | NO |   | 只允许发表特殊主题 |
| allowappend | tinyint(1) unsigned |   | NO |   | 是否开启帖子补充 |
| alloweditrules | tinyint(1) |   | NO |   | 允许版主修改论坛规则 |
| allowfeed | tinyint(1) | 1 | NO |   | 允许推送动态,默认推送广播 |
| allowside | tinyint(1) |   | NO |   | 显示边栏 |
| recyclebin | tinyint(1) |   | NO |   | 是否启用回收站 |
| modnewposts | tinyint(1) |   | NO |   | 是否审核发帖 |
| jammer | tinyint(1) |   | NO |   | 是否启用干扰码 |
| disablewatermark | tinyint(1) |   | NO |   | 是否图片附件增加水印 |
| inheritedmod | tinyint(1) |   | NO |   | 本论坛或分类版主的权力继承到下级论坛 |
| autoclose | smallint(6) |   | NO |   | 自动关闭主题 |
| forumcolumns | tinyint(3) unsigned |   | NO |   | 增加论坛水平横排设置 |
| catforumcolumns | tinyint(3) unsigned |   | NO |   | 增加分区版块水平横排设置 |
| threadcaches | tinyint(1) |   | NO |   | 主题缓存功能设置 |
| alloweditpost | tinyint(1) unsigned | 1 | NO |   | 允许编辑帖子 |
| simple | tinyint(1) unsigned |   | NO |   | 只显示子版块 |
| modworks | tinyint(1) unsigned |   | NO |   | 本版有待处理的管理事项 |
| allowglobalstick | tinyint(1) | 1 | NO |   | 是否显示全局置顶 |
| level | smallint(6) |   | NO |   | 群组等级 |
| commoncredits | int(10) unsigned |   | NO |   | 群组公共积分 |
| archive | tinyint(1) |   | NO |   | 是否有存档表 |
| recommend | smallint(6) unsigned |   | NO |   | 推荐到的版块 |
| favtimes | mediumint(8) unsigned |   | NO |   | 版块或群组的收藏次数 |
| sharetimes | mediumint(8) unsigned |   | NO |   | 版块或群组的分享次数 |
| disablethumb | tinyint(1) |   | NO |   | 是否添加缩略图 |
| disablecollect | tinyint(1) |   | NO |   | 禁止淘帖 |

## pre_forum_forum_threadtable  版块存档信息

| 字段名 | 数据类型 | 默认值 | 允许非空 | 自动递增 | 备注 |
| ------ | -------- | ------ | -------- | -------- | ---- |
| fid | smallint(6) unsigned |   | NO |   | 版块id |
| threadtableid | smallint(6) unsigned |   | NO |   | thread分区id |
| threads | int(11) unsigned |   | NO |   | 主题数 |
| posts | int(11) unsigned |   | NO |   | 帖子数 |
...
| ------ | -------- | ------ | -------- | -------- | ---- |
| fid | mediumint(8) unsigned |   | NO |   | 版块id |
| description | text |   | NO |   | 解释说明 |
| password | varchar(12) |   | NO |   | 私密论坛密码 |
| icon | varchar(255) |   | NO |   | 图标 |
| redirect | varchar(255) |   | NO |   | URL转发 |
| attachextensions | varchar(255) |   | NO |   | 允许上传附件类型 |
| creditspolicy | mediumtext |   | NO |   | 版块积分策略 |
| formulaperm | text |   | NO |   | 版块权限表达式 |
| moderators | text |   | NO |   | 版主列表，格式:admin |
| rules | text |   | NO |   | 版块规则 |
| threadtypes | text |   | NO |   | 主题分类，序列化存放的设置，格式为一个数组 |
| threadsorts | text |   | NO |   | 分类信息，序列化存放的设置，格式为一个数组 |
| viewperm | text |   | NO |   | 阅读权限, 格式:	1	4	5 |
| postperm | text |   | NO |   | 发表权限, 格式:	1	4	5 |
| replyperm | text |   | NO |   | 回复权限, 格式:	1	4	5 |
| getattachperm | text |   | NO |   | 下载附件权限, 格式:	1	4	5 |
| postattachperm | text |   | NO |   | 上传附件权限, 格式:	1	4	5 |
| postimageperm | text |   | NO |   | 上传图片权限, 格式:	1	4	5 |
| spviewperm | text |   | NO |   | 不受限于版权权限表达式, 格式:	1	4	5 |
| seotitle | text |   | NO |   | 版块seo标题 |
| keywords | text |   | NO |   | 版块seo关键词 |
| seodescription | text |   | NO |   | 版块seo描述 |
| supe_pushsetting | text |   | NO |   | supe推送设置，序列化存放设置数据，格式为一个数组。 |
| modrecommend | text |   | NO |   | 版主推荐规则 |
| threadplugin | text |   | NO |   | 特殊主题插件数据 |
| replybg | text |   | NO |   | 回复框背景 |
| extra | text |   | NO |   |   |
| jointype | tinyint(1) |   | NO |   | 加入群组方式 -1为关闭，0为公开， 2邀请 |
| gviewperm | tinyint(1) unsigned |   | NO |   | 群组浏览权限 0:仅成员 1:所有用户 |
| membernum | smallint(6) unsigned |   | NO |   | 群组成员数 |
| dateline | int(10) unsigned |   | NO |   | 群组创建时间 |
| lastupdate | int(10) unsigned |   | NO |   | 群组最后更新时间 |
| activity | int(10) unsigned |   | NO |   | 群组活跃度 |
| founderuid | mediumint(8) unsigned |   | NO |   | 群组创始人UID |
| foundername | varchar(255) |   | NO |   | 群组创始人名称 |
| banner | varchar(255) |   | NO |   | 群组头图片 |
| groupnum | smallint(6) unsigned |   | NO |   | 分类下的群组数量 |
| commentitem | text |   | NO |   |   |
| relatedgroup | text |   | NO |   |   |
| picstyle | tinyint(1) |   | NO |   | 帖子列表是否以图片形式显示 0:否 1:是 |
| widthauto | tinyint(1) |   | NO |   | 默认是否宽屏 0:全局 -1:宽屏 1:窄屏 |
| noantitheft | tinyint(1) |   | NO |   | 禁止防采集 |
| noforumhidewater | tinyint(1) |   | NO |   | 禁止隐藏水帖 |
| noforumrecommend | tinyint(1) |   | NO |   | 禁止推荐回复 |
| livetid | mediumint(8) unsigned |   | NO |   | 版块直播帖tid |
| price | mediumint(8) unsigned |   | NO |   | 进入版块所需支付的积分 |
...
| ------ | -------- | ------ | -------- | -------- | ---- |
| fid | mediumint(8) unsigned |   | NO |   | 版块id |
| tid | mediumint(8) unsigned |   | NO |   | 帖子id |
| typeid | smallint(6) |   | NO |   | 是否含有附件图片 |
| displayorder | tinyint(1) |   | NO |   | 推荐顺序 |
| subject | char(80) |   | NO |   | 推荐主题标题 |
| author | char(15) |   | NO |   | 推荐主题作者 |
| authorid | mediumint(8) |   | NO |   | 推荐主题作者id |
| moderatorid | mediumint(8) |   | NO |   | 推荐管理人员id |
| expiration | int(10) unsigned |   | NO |   | 推荐主题有效期 |
| position | tinyint(1) |   | NO |   | 显示位置 |
| highlight | tinyint(1) |   | NO |   | 高亮颜色 |
| aid | mediumint(8) unsigned |   | NO |   | 附件ID |
| filename | char(100) |   | NO |   | 附件文件 |

## pre_forum_groupcreditslog  群组积分日志表

| 字段名 | 数据类型 | 默认值 | 允许非空 | 自动递增 | 备注 |
| ------ | -------- | ------ | -------- | -------- | ---- |
| fid | mediumint(8) unsigned |   | NO |   | 群组ID |
| uid | mediumint(8) unsigned |   | NO |   | 成员UID |
| logdate | int(8) |   | NO |   | 日期/20100308 |

## pre_forum_groupfield  群组扩展信息缓存

| 字段名 | 数据类型 | 默认值 | 允许非空 | 自动递增 | 备注 |
| ------ | -------- | ------ | -------- | -------- | ---- |
| fid | mediumint(8) unsigned |   | NO |   | 群组关联fid |
| privacy | tinyint(1) unsigned |   | NO |   | 群组隐私设置 |
| dateline | int(10) unsigned |   | NO |   | 缓存生成时间 |
| type | varchar(255) |   | NO |   | 缓存类型 |
| data | text |   | NO |   | 缓存数据 |
...
| ------ | -------- | ------ | -------- | -------- | ---- |
| fid | mediumint(8) unsigned |   | NO |   | 群组id |
| uid | mediumint(8) unsigned |   | NO |   | 邀请人id |
| inviteuid | mediumint(8) unsigned |   | NO |   | 被邀请人id |
| dateline | int(10) unsigned |   | NO |   | 邀请时间 |
...
| 字段名 | 数据类型 | 默认值 | 允许非空 | 自动递增 | 备注 |
| ------ | -------- | ------ | -------- | -------- | ---- |
| levelid | smallint(6) unsigned |   | NO | 是 | 等级ID |
| type | enum('special','default') | default | NO |   | 类型 |
| leveltitle | varchar(255) |   | NO |   | 群组等级名称 |
| creditshigher | int(10) |   | NO |   | 该等级的积分上限 |
| creditslower | int(10) |   | NO |   | 该等级的积分下限 |
| icon | varchar(255) |   | NO |   | 等级图标 |
| creditspolicy | text |   | NO |   | 积分策略 |
| postpolicy | text |   | NO |   | 帖子策略 |
| specialswitch | text |   | NO |   | 特殊开能开关 |
...
| ------ | -------- | ------ | -------- | -------- | ---- |
| fid | mediumint(8) unsigned |   | NO |   | 群组关联fid |
| uid | mediumint(8) unsigned |   | NO |   | 成员id |
| username | char(15) |   | NO |   | 成员名 |
| level | tinyint(3) unsigned |   | NO |   | 成员等级
        (0:待审核 1:群主 2:副群主 3:明星成员 4:普通成员) |
| threads | mediumint(8) unsigned |   | NO |   | 成员主题数 |
| replies | mediumint(8) unsigned |   | NO |   | 成员回复数 |
| joindateline | int(10) unsigned |   | NO |   | 成员加入群组时间 |
| lastupdate | int(10) unsigned |   | NO |   | 成员最后活动时间 |
| privacy | tinyint(1) unsigned |   | NO |   | 成员隐私设置 |

## pre_forum_hotreply_member  回帖投票会员记录表
...
| pid | int(10) unsigned |   | NO |   | 帖子ID |
| uid | mediumint(8) unsigned |   | NO |   | 用户ID |
| attitude | tinyint(1) unsigned |   | NO |   | 用户投票值 |
...
| pid | int(10) unsigned |   | NO |   | 帖子ID |
| tid | mediumint(8) unsigned |   | NO |   | 主题ID |
| support | smallint(6) unsigned |   | NO |   | 支持数 |
| against | smallint(6) unsigned |   | NO |   | 反对数 |
| total | mediumint(8) unsigned |   | NO |   | 总数 |

## pre_forum_imagetype  图片 表情 头像等 分类

| 字段名 | 数据类型 | 默认值 | 允许非空 | 自动递增 | 备注 |
| ------ | -------- | ------ | -------- | -------- | ---- |
| typeid | smallint(6) unsigned |   | NO | 是 | 分类id |
| available | tinyint(1) |   | NO |   | 是否启用 |
| name | char(20) |   | NO |   | 分类名称 |
| type | enum('smiley','icon','avatar') | smiley | NO |   | 分类类型
        (smiley:表情 icon:图标 avatar:头像) |
| displayorder | tinyint(3) |   | NO |   | 分类顺序 |
| directory | char(100) |   | NO |   | 图片目录 |

## pre_forum_medal  勋章表

| 字段名 | 数据类型 | 默认值 | 允许非空 | 自动递增 | 备注 |
| ------ | -------- | ------ | -------- | -------- | ---- |
| medalid | smallint(6) unsigned |   | NO | 是 | 勋章id |
| name | varchar(50) |   | NO |   | 勋章名称 |
| available | tinyint(1) |   | NO |   | 是否启用 |
| image | varchar(255) |   | NO |   | 勋章图片 |
| type | tinyint(1) |   | NO |   | 勋章类型 |
| displayorder | tinyint(3) |   | NO |   | 勋章显示顺序 |
| description | varchar(255) |   | NO |   | 勋章描述 |
| expiration | smallint(6) unsigned |   | NO |   | 勋章有效期 |
| permission | mediumtext |   | NO |   | 勋章获得条件表达式 |
| credit | tinyint(1) unsigned |   | NO |   | 勋章购买使用积分 |
| price | mediumint(8) unsigned |   | NO |   | 勋章价格 |
...
| ------ | -------- | ------ | -------- | -------- | ---- |
| id | mediumint(8) unsigned |   | NO | 是 | 记录id |
| uid | mediumint(8) unsigned |   | NO |   | 勋章拥有着用户id |
| medalid | smallint(6) unsigned |   | NO |   | 勋章id |
| type | tinyint(1) |   | NO |   | 勋章类型id |
| dateline | int(10) unsigned |   | NO |   | 颁发时间id |
| expiration | int(10) unsigned |   | NO |   | 有效期id |
| status | tinyint(1) |   | NO |   | 勋章状态id |
...
| ------ | -------- | ------ | -------- | -------- | ---- |
| tid | mediumint(8) unsigned |   | NO |   | 主题ID |
| recommenduid | mediumint(8) unsigned |   | NO |   | 推荐会员ID |
| dateline | int(10) unsigned |   | NO |   | 推荐时间 |
...
| ------ | -------- | ------ | -------- | -------- | ---- |
| uid | mediumint(8) unsigned |   | NO |   | 会员id |
| modaction | char(3) |   | NO |   | 动作 |
| dateline | date | 2006-01-01 | NO |   | 时间段 |
| count | smallint(6) unsigned |   | NO |   | 登录次数 |
| posts | smallint(6) unsigned |   | NO |   | 发表数 |

## pre_forum_newthread  最新主题表

| 字段名 | 数据类型 | 默认值 | 允许非空 | 自动递增 | 备注 |
| ------ | -------- | ------ | -------- | -------- | ---- |
| tid | mediumint(8) unsigned |   | NO |   | 主题ID |
| fid | mediumint(8) unsigned |   | NO |   | 版块ID |
| dateline | int(10) unsigned |   | NO |   | 日期 |
...
| groupid | smallint(6) unsigned |   | NO |   | 会员组id |
| displayorder | tinyint(3) |   | NO |   | 显示顺序 |
| title | varchar(30) |   | NO |   | 组名称 |
| url | varchar(30) |   | NO |   | 图例URL |

## pre_forum_order  订单信息表

| 字段名 | 数据类型 | 默认值 | 允许非空 | 自动递增 | 备注 |
| ------ | -------- | ------ | -------- | -------- | ---- |
| orderid | char(32) |   | NO |   | 订单号id |
| status | char(3) |   | NO |   | 状态 |
| buyer | char(50) |   | NO |   | 购买者姓名 |
| admin | char(15) |   | NO |   | 补单管理员姓名 |
| uid | mediumint(8) unsigned |   | NO |   | 购买者id |
| amount | int(10) unsigned |   | NO |   | 数量 |
| price | float(7,2) unsigned | 0.00 | NO |   | 价格 |
| submitdate | int(10) unsigned |   | NO |   | 提交日期 |
| confirmdate | int(10) unsigned |   | NO |   | 确认日期 |
| email | char(40) |   | NO |   | 购买时的Email |
| ip | char(15) |   | NO |   | 购买时的IP |
...
| ------ | -------- | ------ | -------- | -------- | ---- |
| tid | mediumint(8) unsigned |   | NO |   | 主题id |
| overt | tinyint(1) |   | NO |   | 是否公开投票参与人 |
| multiple | tinyint(1) |   | NO |   | 是否多选 |
| visible | tinyint(1) |   | NO |   | 是否投票后可见 |
| maxchoices | tinyint(3) unsigned |   | NO |   | 最大可选项数 |
| isimage | tinyint(1) |   | NO |   | 是否为图片投票0: 普通投票; 1:图片投票 |
| expiration | int(10) unsigned |   | NO |   | 过期时间 |
| pollpreview | varchar(255) |   | NO |   | 选项内容前两项预览 |
| voters | mediumint(8) unsigned |   | NO |   | 投票人数 |

## pre_forum_polloption  投票选项表

| 字段名 | 数据类型 | 默认值 | 允许非空 | 自动递增 | 备注 |
| ------ | -------- | ------ | -------- | -------- | ---- |
| polloptionid | int(10) unsigned |   | NO | 是 | 选项id |
| tid | mediumint(8) unsigned |   | NO |   | 主题id |
| votes | mediumint(8) unsigned |   | NO |   | 票数 |
| displayorder | tinyint(3) |   | NO |   | 显示顺序 |
| polloption | varchar(80) |   | NO |   | 选项内容 |
| voterids | mediumtext |   | NO |   | 投票人id |

## pre_forum_polloption_image  投票选项图片

| 字段名 | 数据类型 | 默认值 | 允许非空 | 自动递增 | 备注 |
| ------ | -------- | ------ | -------- | -------- | ---- |
| aid | int(10) unsigned |   | NO | 是 | 图片附件id |
| poid | int(10) unsigned |   | NO |   | 选项id |
| tid | mediumint(8) unsigned |   | NO |   | 主题id |
| pid | int(10) unsigned |   | NO |   | 帖子id |
| uid | mediumint(8) unsigned |   | NO |   | 会员id |
| filename | varchar(255) |   | NO |   | 原文件名 |
...
| remote | tinyint(1) unsigned |   | NO |   | 是否远程附件 |
| width | smallint(6) unsigned |   | NO |   | 附件宽度 |
| thumb | tinyint(1) unsigned |   | NO |   | 是否有缩略率图 |
| dateline | int(10) unsigned |   | NO |   | 上传时间 |
...
| tid | mediumint(8) unsigned |   | NO |   | 主题id |
| uid | mediumint(8) unsigned |   | NO |   | 会员id |
| username | varchar(15) |   | NO |   | 会员名 |
| options | text |   | NO |   | 选项 	 分隔 |
| dateline | int(10) unsigned |   | NO |   | 发表时间 |
...
| invisible | tinyint(1) |   | NO |   | 是否通过审核 |
| anonymous | tinyint(1) |   | NO |   | 是否匿名 |
| usesig | tinyint(1) |   | NO |   | 是否启用签名 |
| htmlon | tinyint(1) |   | NO |   | 是否允许HTML |
| bbcodeoff | tinyint(1) |   | NO |   | 是否关闭BBCODE |
| smileyoff | tinyint(1) |   | NO |   | 是否关闭表情 |
| parseurloff | tinyint(1) |   | NO |   | 是否允许粘贴URL |
| attachment | tinyint(1) |   | NO |   | 附件 |
| rate | smallint(6) |   | NO |   | 评分分数 |
| ratetimes | tinyint(3) unsigned |   | NO |   | 评分次数 |
| status | int(10) |   | NO |   | 帖子状态 |
| tags | varchar(255) |   | NO |   | 新增字段，用于存放tag |
| comment | tinyint(1) |   | NO |   | 是否存在点评 |
| replycredit | int(10) |   | NO |   | 回帖获得积分记录 |
| position | int(8) unsigned |   | NO | 是 | 帖子位置信息 |
...
| tid | mediumint(8) unsigned |   | YES |   |   |
| uid | mediumint(8) unsigned |   | YES |   |   |
| mapx | varchar(255) |   | NO |   |   |
| mapy | varchar(255) |   | NO |   |   |
...
| 字段名 | 数据类型 | 默认值 | 允许非空 | 自动递增 | 备注 |
| ------ | -------- | ------ | -------- | -------- | ---- |
| id | int(10) unsigned |   | NO |   | ID |
| status | tinyint(3) |   | NO |   | 状态 0 审核中，1 已忽略 |
| dateline | int(10) unsigned |   | NO |   |   |
...
| 字段名 | 数据类型 | 默认值 | 允许非空 | 自动递增 | 备注 |
| ------ | -------- | ------ | -------- | -------- | ---- |
| pid | int(10) unsigned |   | NO | 是 | Post ID |
...
| tid | mediumint(8) unsigned |   | NO |   | 主题ID |
| pid | int(10) unsigned |   | NO |   | 帖子ID |
| author | varchar(15) |   | NO |   | 作者 |
| authorid | mediumint(8) |   | NO |   | 作者ID x1.5以后：0为游客　-1为观点 |
| dateline | int(10) unsigned |   | NO |   | 时间 |
| comment | varchar(255) |   | NO |   | 点评内容 |
| score | tinyint(1) |   | NO |   | 是否包含点评观点 |
| useip | varchar(15) |   | NO |   | 发帖者IP |
| rpid | int(10) unsigned |   | NO |   | 关联的帖子ID |
...
| ------ | -------- | ------ | -------- | -------- | ---- |
| pid | int(10) unsigned |   | NO |   |   |
| tid | mediumint(8) unsigned |   | NO |   |   |
| fid | smallint(6) unsigned |   | NO |   |   |
| uid | mediumint(8) unsigned |   | NO |   |   |
| action | char(10) |   | NO |   |   |
| dateline | int(10) unsigned |   | NO |   |   |
...
| uid | mediumint(8) unsigned |   | NO |   | 会员id |
| username | char(15) |   | NO |   | 会员名 |
| extcredits | tinyint(1) unsigned |   | NO |   | 评分字段 |
| dateline | int(10) unsigned |   | NO |   | 评分时间 |
| score | smallint(6) |   | NO |   | 分数 |
| reason | char(40) |   | NO |   | 操作理由 |

## pre_forum_relatedthread  相关主题表

| 字段名 | 数据类型 | 默认值 | 允许非空 | 自动递增 | 备注 |
| ------ | -------- | ------ | -------- | -------- | ---- |
| tid | mediumint(8) |   | NO |   | 主题id |
| type | enum('general','trade') | general | NO |   | 关键词类型 |
| expiration | int(10) |   | NO |   | 过期时间 |
| keywords | varchar(255) |   | NO |   | 关键字 |
| relatedthreads | text |   | NO |   | 相关主题序列 |

## pre_forum_replycredit  主题回帖获得积分规则表

| 字段名 | 数据类型 | 默认值 | 允许非空 | 自动递增 | 备注 |
| ------ | -------- | ------ | -------- | -------- | ---- |
| tid | mediumint(6) unsigned |   | NO |   | 主题tid |
| extcredits | mediumint(6) unsigned |   | NO |   | 单次回复奖励额度 |
| extcreditstype | tinyint(1) |   | NO |   | 本规则下奖励积分的类型 |
| times | smallint(6) unsigned |   | NO |   | 回复奖励次数 |
| membertimes | smallint(6) unsigned |   | NO |   | 单个用户参与次数 |
| random | tinyint(1) |   | NO |   | 用户设置的回帖奖励几率 |

## pre_forum_rsscache  rss缓存表

| 字段名 | 数据类型 | 默认值 | 允许非空 | 自动递增 | 备注 |
| ------ | -------- | ------ | -------- | -------- | ---- |
| lastupdate | int(10) unsigned |   | NO |   | 最后更新时间 |
| fid | mediumint(8) unsigned |   | NO |   | 论坛id |
| tid | mediumint(8) unsigned |   | NO |   | 主题id |
| dateline | int(10) unsigned |   | NO |   | 发表时间 |
| forum | char(50) |   | NO |   | 论坛名称 |
| author | char(15) |   | NO |   | 作者 |
| subject | char(80) |   | NO |   | 标题 |
| description | char(255) |   | NO |   | 解释说明 |
| guidetype | char(10) |   | NO |   | 导读中的类型 |

## pre_forum_sofa  抢沙发列表

| 字段名 | 数据类型 | 默认值 | 允许非空 | 自动递增 | 备注 |
| ------ | -------- | ------ | -------- | -------- | ---- |
| tid | mediumint(8) unsigned |   | NO |   | 零回复主题id |
| fid | mediumint(8) unsigned |   | NO |   | 版块id |
...
| 字段名 | 数据类型 | 默认值 | 允许非空 | 自动递增 | 备注 |
| ------ | -------- | ------ | -------- | -------- | ---- |
| uid | mediumint(8) unsigned |   | NO |   | 用户 uid |
| variable | varchar(20) |   | NO |   | 缓存变量的名称 |
| value | text |   | NO |   | 缓存变量的值 |
| expiration | int(10) unsigned |   | NO |   | 过期时间 |
...
| 字段名 | 数据类型 | 默认值 | 允许非空 | 自动递增 | 备注 |
| ------ | -------- | ------ | -------- | -------- | ---- |
| logdate | date |   | NO |   | 日志日期 |
| fid | mediumint(8) unsigned |   | NO |   | 版块ID |
| type | smallint(5) unsigned |   | NO |   | 记录类型 -- 1:发帖数 |
| value | int(10) unsigned |   | NO |   | 记录值 |

## pre_forum_thread  主题表

| 字段名 | 数据类型 | 默认值 | 允许非空 | 自动递增 | 备注 |
| ------ | -------- | ------ | -------- | -------- | ---- |
| tid | mediumint(8) unsigned |   | NO | 是 | 主题id |
| fid | mediumint(8) unsigned |   | NO |   | 上级论坛 |
| posttableid | smallint(6) unsigned |   | NO |   | 帖子表ID |
| typeid | smallint(6) unsigned |   | NO |   | 主题分类id |
| sortid | smallint(6) unsigned |   | NO |   | 分类信息id |
| readperm | tinyint(3) unsigned |   | NO |   | 阅读权限 |
| price | smallint(6) |   | NO |   | 价格 |
| author | char(15) |   | NO |   | 会员名 |
| authorid | mediumint(8) unsigned |   | NO |   | 会员id |
| subject | char(80) |   | NO |   | 标题 |
| dateline | int(10) unsigned |   | NO |   | 发表时间 |
| lastpost | int(10) unsigned |   | NO |   | 最后发表 |
| lastposter | char(15) |   | NO |   | 最后发表人id |
| views | int(10) unsigned |   | NO |   | 浏览次数 |
| replies | mediumint(8) unsigned |   | NO |   | 回复次数 |
| displayorder | tinyint(1) |   | NO |   | 显示顺序 |
| highlight | tinyint(1) |   | NO |   | 是否高亮 |
| digest | tinyint(1) |   | NO |   | 是否精华 |
| rate | tinyint(1) |   | NO |   | 是否评分 |
| special | tinyint(1) |   | NO |   | 特殊主题,1:投票;2:商品;3:悬赏;4:活动;5:辩论贴;127:插件相关 |
| attachment | tinyint(1) |   | NO |   | 附件,0无附件 1普通附件 2有图片附件 |
| moderated | tinyint(1) |   | NO |   | 是否被管理员改动 |
| closed | mediumint(8) unsigned |   | NO |   | 是否关闭 |
| stickreply | tinyint(1) unsigned |   | NO |   | 是否有回帖置顶 |
| recommends | smallint(6) |   | NO |   | 推荐指数 |
| recommend_add | smallint(6) |   | NO |   | 支持人数 |
| recommend_sub | smallint(6) |   | NO |   | 反对人数 |
| heats | int(10) unsigned |   | NO |   | 主题热度值 |
| status | smallint(6) unsigned |   | NO |   |   |
| isgroup | tinyint(1) |   | NO |   | 是否为群组帖子 |
| favtimes | mediumint(8) |   | NO |   | 主题收藏次数 |
| sharetimes | mediumint(8) |   | NO |   | 主题分享次数 |
| stamp | tinyint(3) | -1 | NO |   | 主题图章 |
| icon | tinyint(3) | -1 | NO |   | 主题图标 |
| pushedaid | mediumint(8) |   | NO |   | 被推送到的文章aid |
| cover | smallint(6) |   | NO |   | 主题封面  负数:远程　正数:本地 0:无封面 |
| replycredit | smallint(6) |   | NO |   | 回帖奖励积分主题记录积分值 |
| relatebytag | char(255) |   | NO |   | 根据帖子标签取的相关主题id (time /t tid,...) |
| maxposition | int(8) unsigned |   | NO |   | 最大回帖位置信息 |
| bgcolor | char(8) |   | NO |   | 保存高亮背景色 |
| comments | int(10) unsigned |   | NO |   | 点评数 |
...
| ------ | -------- | ------ | -------- | -------- | ---- |
| tid | mediumint(8) unsigned |   | NO |   | 主题id |
| addviews | int(10) unsigned |   | NO |   | 浏览次数 |

## pre_forum_threadcalendar  热帖日历表

| 字段名 | 数据类型 | 默认值 | 允许非空 | 自动递增 | 备注 |
| ------ | -------- | ------ | -------- | -------- | ---- |
| cid | mediumint(8) unsigned |   | NO | 是 | 帖子日历ID |
| fid | mediumint(8) unsigned |   | NO |   | 版块ID |
| dateline | int(10) unsigned |   | NO |   | 日期 |
| hotnum | int(10) unsigned |   | NO |   | 热帖总数 |

## pre_forum_threadclass  主题分类表

| 字段名 | 数据类型 | 默认值 | 允许非空 | 自动递增 | 备注 |
| ------ | -------- | ------ | -------- | -------- | ---- |
| typeid | mediumint(8) unsigned |   | NO | 是 | 分类ID |
| fid | mediumint(8) unsigned |   | NO |   | 所属版块ID |
| name | varchar(255) |   | NO |   | 分类名称 |
| displayorder | mediumint(9) |   | NO |   | 显示顺序 |
| icon | varchar(255) |   | NO |   | 分类图标URL |
| moderators | tinyint(1) |   | NO |   | 仅管理者可用 |

## pre_forum_threadclosed  主题转移后保留的指向记录

| 字段名 | 数据类型 | 默认值 | 允许非空 | 自动递增 | 备注 |
| ------ | -------- | ------ | -------- | -------- | ---- |
| tid | mediumint(8) unsigned |   | NO |   | 对应源主题 |
| redirect | mediumint(8) unsigned |   | NO |   | 保留的指向 tid |
...
## pre_forum_threadhot  热帖日历数据表

| 字段名 | 数据类型 | 默认值 | 允许非空 | 自动递增 | 备注 |
| ------ | -------- | ------ | -------- | -------- | ---- |
| cid | mediumint(8) unsigned |   | NO |   | 帖子日历ID |
| fid | mediumint(8) unsigned |   | NO |   | 版块ID |
| tid | mediumint(8) unsigned |   | NO |   | 主题ID |
...
| fid | smallint(6) unsigned |   | NO |   |   |
| uid | mediumint(8) unsigned |   | NO |   |   |
| otherid | smallint(6) unsigned |   | NO |   |   |
| action | char(10) |   | NO |   |   |
| expiry | int(10) unsigned |   | NO |   |   |
| dateline | int(10) unsigned |   | NO |   |   |
...
| username | char(15) |   | NO |   | 会员名 |
| dateline | int(10) unsigned |   | NO |   | 操作时间 |
| expiration | int(10) unsigned |   | NO |   | 有效时间 |
| action | char(5) |   | NO |   | 操作 |
| status | tinyint(1) |   | NO |   | 状态 |
| magicid | smallint(6) unsigned |   | NO |   | 使用道具id |
| stamp | tinyint(3) |   | NO |   | 主题图章/图标 ID |
| reason | char(40) |   | NO |   | 操作原因 |
...
| tid | mediumint(8) unsigned |   | NO |   | 主题id |
| uid | mediumint(8) unsigned |   | NO |   | 会员id |
| dateline | int(10) unsigned |   | NO |   | 参与时间 |
...
| ------ | -------- | ------ | -------- | -------- | ---- |
| tid | mediumint(8) unsigned |   | NO |   | 主题ID |
| relay | int(10) unsigned |   | NO |   | 转播次数 |
| content | text |   | NO |   | 主题内容预览 |

## pre_forum_threadprofile  贴内用户信息设置
...
| name | char(100) |   | NO |   | 名称 |
| template | text |   | NO |   | 模板 |
| global | tinyint(1) |   | NO |   | 全局 |

## pre_forum_threadprofile_group  贴内用户信息用户组

| 字段名 | 数据类型 | 默认值 | 允许非空 | 自动递增 | 备注 |
| ------ | -------- | ------ | -------- | -------- | ---- |
| gid | mediumint(8) |   | NO |   | 关联用户组、认证组id |
| tpid | mediumint(8) unsigned |   | NO |   | id |
...
| ------ | -------- | ------ | -------- | -------- | ---- |
| tid | mediumint(8) unsigned |   | NO |   | 主题id |
| stopfloor | mediumint(8) unsigned |   | NO |   | 截止楼层 |
| starttimefrom | int(10) unsigned |   | NO |   | 开始时间 |
| starttimeto | int(10) unsigned |   | NO |   | 结束时间 |
| rewardfloor | text |   | NO |   | 奖励楼层 |
| creditlimit | int(10) | -996 | NO |   | 积分下限 |
| replylimit | smallint(6) |   | NO |   | 回帖次数上限 |

## pre_forum_threadtype  分类信息表

| 字段名 | 数据类型 | 默认值 | 允许非空 | 自动递增 | 备注 |
| ------ | -------- | ------ | -------- | -------- | ---- |
| typeid | smallint(6) unsigned |   | NO | 是 | 分类信息id |
| fid | mediumint(8) unsigned |   | NO |   |   |
| displayorder | smallint(6) |   | NO |   | 显示顺序 |
| name | varchar(255) |   | NO |   | 名称 |
| description | varchar(255) |   | NO |   | 解释说明 |
| icon | varchar(255) |   | NO |   | 分类图标URL |
| special | smallint(6) |   | NO |   | 分类状态 |
| modelid | smallint(6) unsigned |   | NO |   | 分类模型id |
| expiration | tinyint(1) |   | NO |   | 分类有效期 |
| template | text |   | NO |   | 分类信息内容模板 |
| stemplate | text |   | NO |   | 分类信息主题模板 |
| ptemplate | text |   | NO |   | 分类信息发帖模板 |
| btemplate | text |   | NO |   | 分类信息模块调用模板 |
...
| pid | int(10) unsigned |   | NO |   | 帖子id |
| typeid | smallint(6) unsigned |   | NO |   | 主题分类id |
| sellerid | mediumint(8) unsigned |   | NO |   | 卖家id |
| seller | char(15) |   | NO |   | 卖家名 |
| account | char(50) |   | NO |   | 卖家帐号 |
| tenpayaccount | char(20) |   | NO |   | 卖家财付通账号 |
| subject | char(100) |   | NO |   | 标题 |
| price | decimal(8,2) |   | NO |   | 价格 |
| amount | smallint(6) unsigned | 1 | NO |   | 数量 |
| quality | tinyint(1) unsigned |   | NO |   | 成色 |
| locus | char(20) |   | NO |   | 所在地 |
| transport | tinyint(1) |   | NO |   | 物流方式 |
| ordinaryfee | smallint(4) unsigned |   | NO |   | 平邮附加费 |
| expressfee | smallint(4) unsigned |   | NO |   | 快递附加费 |
| emsfee | smallint(4) unsigned |   | NO |   | EMS附加费 |
| itemtype | tinyint(1) |   | NO |   | 商品类型 |
| dateline | int(10) unsigned |   | NO |   | 交易时间 |
| expiration | int(10) unsigned |   | NO |   | 过期时间 |
| lastbuyer | char(15) |   | NO |   | 最后买家用户名 |
| lastupdate | int(10) unsigned |   | NO |   | 最后交易时间 |
| totalitems | smallint(5) unsigned |   | NO |   | 总交易量 |
| tradesum | decimal(8,2) | 0.00 | NO |   | 总交易额 |
| closed | tinyint(1) |   | NO |   | 是否关闭 |
| aid | mediumint(8) unsigned |   | NO |   | 商品图片的 Aid |
| displayorder | tinyint(1) |   | NO |   | 显示顺序 |
| costprice | decimal(8,2) |   | NO |   | 商品原价 |
| credit | int(10) unsigned |   | NO |   | 积分价格 |
| costcredit | int(10) unsigned |   | NO |   | 积分原价 |
| credittradesum | int(10) unsigned |   | NO |   | 总积分交易额 |

## pre_forum_tradecomment  信用评价

| 字段名 | 数据类型 | 默认值 | 允许非空 | 自动递增 | 备注 |
| ------ | -------- | ------ | -------- | -------- | ---- |
| id | mediumint(8) |   | NO | 是 | id |
| orderid | char(32) |   | NO |   | 订单 id |
| pid | int(10) unsigned |   | NO |   | 帖子 id |
| type | tinyint(1) |   | NO |   | 类型 |
| raterid | mediumint(8) unsigned |   | NO |   | 评价方会员id |
| rater | char(15) |   | NO |   | 评价方用户名 |
| rateeid | mediumint(8) unsigned |   | NO |   | 被评价方会员id |
| ratee | char(15) |   | NO |   | 被评价方用户名 |
| message | char(200) |   | NO |   | 评价内容 |
| explanation | char(200) |   | NO |   | 解释 |
| score | tinyint(1) |   | NO |   | 评分 |
| dateline | int(10) unsigned |   | NO |   | 评价时间 |
...
| tid | mediumint(8) unsigned |   | NO |   | 主题id |
| pid | int(10) unsigned |   | NO |   | 帖子id |
| orderid | varchar(32) |   | NO |   | 订单号id |
| tradeno | varchar(32) |   | NO |   | 支付宝订单号 |
| paytype | tinyint(1) unsigned |   | NO |   | 在线支付方式 |
| subject | varchar(100) |   | NO |   | 标题 |
| price | decimal(8,2) | 0.00 | NO |   | 价格 |
| quality | tinyint(1) unsigned |   | NO |   | 成色 |
| itemtype | tinyint(1) |   | NO |   | 商品类型 |
| number | smallint(5) unsigned |   | NO |   | 数量 |
| tax | decimal(6,2) unsigned | 0.00 | NO |   | 交易手续费 |
| locus | varchar(100) |   | NO |   | 物品所在地 |
| sellerid | mediumint(8) unsigned |   | NO |   | 卖家id |
| seller | varchar(15) |   | NO |   | 卖家名 |
| selleraccount | varchar(50) |   | NO |   | 卖家交易帐号 |
| tenpayaccount | varchar(20) |   | NO |   | 卖家财付通账号 |
| buyerid | mediumint(8) unsigned |   | NO |   | 买家id |
| buyer | varchar(15) |   | NO |   | 买家名 |
| buyercontact | varchar(50) |   | NO |   | 买家联系方式 |
| buyercredits | smallint(5) unsigned |   | NO |   | 买家暂扣积分 |
| buyermsg | varchar(200) |   | YES |   | 买家留言 |
| status | tinyint(1) |   | NO |   | 状态 |
| lastupdate | int(10) unsigned |   | NO |   | 状态最后更新 |
| offline | tinyint(1) |   | NO |   | 是否离线交易 |
| buyername | varchar(50) |   | NO |   | 买家姓名 |
| buyerzip | varchar(10) |   | NO |   | 买家邮编 |
| buyerphone | varchar(20) |   | NO |   | 买家电话 |
| buyermobile | varchar(20) |   | NO |   | 买家手机 |
| transport | tinyint(1) |   | NO |   | 运输方式 |
| transportfee | smallint(6) unsigned |   | NO |   | 运输费用 |
| baseprice | decimal(8,2) |   | NO |   | 商品原价 |
| discount | tinyint(1) |   | NO |   | 折扣 |
| ratestatus | tinyint(1) |   | NO |   | 评价状态 |
| message | text |   | NO |   | 订单留言 |
| credit | int(10) unsigned |   | NO |   | 积分价格 |
| basecredit | int(10) unsigned |   | NO |   | 积分原价 |

## pre_forum_typeoption  分类信息设置项目表

| 字段名 | 数据类型 | 默认值 | 允许非空 | 自动递增 | 备注 |
| ------ | -------- | ------ | -------- | -------- | ---- |
| optionid | smallint(6) unsigned |   | NO | 是 | 分类信息项目ID |
| classid | smallint(6) unsigned |   | NO |   | 分类信息上级项目ID |
| displayorder | tinyint(3) |   | NO |   | 分类信息排序 |
| expiration | tinyint(1) |   | NO |   | 分类信息项目是否受有效期限制 |
| protect | varchar(255) |   | NO |   | 分类信息项目是否是保护项目 |
| title | varchar(255) |   | NO |   | 分类信息项目标题 |
| description | varchar(255) |   | NO |   | 分类信息项目描述 |
| identifier | varchar(255) |   | NO |   | 分类信息项目标识 |
| type | varchar(255) |   | NO |   | 分类信息项目类型 |
| unit | varchar(255) |   | NO |   | 分类信息项目单位 |
| rules | mediumtext |   | NO |   | 分类信息项目规则 |
| permprompt | mediumtext |   | NO |   | 分类信息项目权限提示 |
...
| ------ | -------- | ------ | -------- | -------- | ---- |
| sortid | smallint(6) unsigned |   | NO |   | 分类信息id |
| tid | mediumint(8) unsigned |   | NO |   | 分类信息数据对应帖子id |
| fid | mediumint(8) unsigned |   | NO |   | 分类信息数据对应帖子板块id |
| optionid | smallint(6) unsigned |   | NO |   | 分类信息数据对应选项id |
| expiration | int(10) unsigned |   | NO |   | 分类信息数据有效期 |
| value | mediumtext |   | NO |   | 分类信息数据数值 |

## pre_forum_typevar  分类信息对应项目表

| 字段名 | 数据类型 | 默认值 | 允许非空 | 自动递增 | 备注 |
| ------ | -------- | ------ | -------- | -------- | ---- |
| sortid | smallint(6) |   | NO |   | 分类信息id |
| optionid | smallint(6) |   | NO |   | 分类信息对应项目id |
| available | tinyint(1) |   | NO |   | 分类信息对应项目是否可用 |
| required | tinyint(1) |   | NO |   | 分类信息对应项目是否必填 |
| unchangeable | tinyint(1) |   | NO |   | 分类信息对应项目是否可修改 |
| search | tinyint(1) |   | NO |   | 分类信息对应项目是否可搜索 |
| displayorder | tinyint(3) |   | NO |   | 分类信息对应项目顺序 |
| subjectshow | tinyint(1) |   | NO |   |   |

## pre_forum_warning  警告记录表

| 字段名 | 数据类型 | 默认值 | 允许非空 | 自动递增 | 备注 |
| ------ | -------- | ------ | -------- | -------- | ---- |
| wid | int(10) unsigned |   | NO | 是 | 记录id |
| pid | int(10) unsigned |   | NO |   | 帖子 pid |
| operatorid | mediumint(8) unsigned |   | NO |   | 警告者 Uid |
| operator | char(15) |   | NO |   | 警告者用户名 |
| authorid | mediumint(8) unsigned |   | NO |   | 被警告者 uid |
| author | char(15) |   | NO |   | 被警告者用户名 |
| dateline | int(10) unsigned |   | NO |   | 警告时间 |
| reason | char(40) |   | NO |   | 警告原因 |

## pre_home_album  相册表

| 字段名 | 数据类型 | 默认值 | 允许非空 | 自动递增 | 备注 |
| ------ | -------- | ------ | -------- | -------- | ---- |
| albumid | mediumint(8) unsigned |   | NO | 是 | 相册ID |
| albumname | varchar(50) |   | NO |   | 相册名字 |
| catid | smallint(6) unsigned |   | NO |   | 相册系统分类 |
| uid | mediumint(8) unsigned |   | NO |   | 相册用户ID |
| username | varchar(15) |   | NO |   | 相册用户名 |
| dateline | int(10) unsigned |   | NO |   | 相册建立时间戳 |
| updatetime | int(10) unsigned |   | NO |   | 相册最后修改时间戳 |
| picnum | smallint(6) unsigned |   | NO |   | 相册照片数量 |
| pic | varchar(255) |   | NO |   | 相册封面照片 |
| picflag | tinyint(1) |   | NO |   | 相册是否有图片 |
| friend | tinyint(1) |   | NO |   | 相册隐私设置:"0"全站用户可见,"1"为全好友可见,"2"为仅指定的好友可见,"3"为仅自己可见,"4"为凭密码查看 |
| password | varchar(10) |   | NO |   | 相册密码 |
| target_ids | text |   | NO |   | 允许查看相册的用户ID,多个用户ID用"m"间隔 |
| favtimes | mediumint(8) unsigned |   | NO |   | 相册收藏次数 |
| sharetimes | mediumint(8) unsigned |   | NO |   | 相册分享次数 |
| depict | text |   | NO |   | 相册描述 |
...
| 字段名 | 数据类型 | 默认值 | 允许非空 | 自动递增 | 备注 |
| ------ | -------- | ------ | -------- | -------- | ---- |
| catid | mediumint(8) unsigned |   | NO | 是 | 栏目id |
| upid | mediumint(8) unsigned |   | NO |   | 上级栏目id |
| catname | varchar(255) |   | NO |   | 标题 |
| num | mediumint(8) unsigned |   | NO |   | 相册数 |
| displayorder | smallint(6) |   | NO |   | 显示顺序 |
...
| 字段名 | 数据类型 | 默认值 | 允许非空 | 自动递增 | 备注 |
| ------ | -------- | ------ | -------- | -------- | ---- |
| logid | mediumint(8) unsigned |   | NO | 是 | 序列id |
| uid | mediumint(8) unsigned |   | NO |   | 用户id |
| appid | mediumint(8) unsigned |   | NO |   | 用户名 |
| appname | varchar(60) |   | NO |   | 应用名称 |
| type | tinyint(1) |   | NO |   | 积分转入转出类型 |
| credit | mediumint(8) unsigned |   | NO |   | 积分数 |
| note | text |   | NO |   | 备注 |
| dateline | int(10) unsigned |   | NO |   | 操作时间 |
...
| ------ | -------- | ------ | -------- | -------- | ---- |
| uid | mediumint(8) unsigned |   | NO |   | 用户ID |
| buid | mediumint(8) unsigned |   | NO |   | 被屏蔽的用户ID |
| dateline | int(10) unsigned |   | NO |   | 被屏蔽的时间戳 |

## pre_home_blog  日志表

| 字段名 | 数据类型 | 默认值 | 允许非空 | 自动递增 | 备注 |
| ------ | -------- | ------ | -------- | -------- | ---- |
| blogid | mediumint(8) unsigned |   | NO | 是 | 日志ID |
| uid | mediumint(8) unsigned |   | NO |   | 日志所属用户ID |
| username | char(15) |   | NO |   | 日志所属用户名 |
| subject | char(80) |   | NO |   | 日志标题 |
| classid | smallint(6) unsigned |   | NO |   | 个人分类id |
| catid | smallint(6) unsigned |   | NO |   | 系统分类id |
| viewnum | mediumint(8) unsigned |   | NO |   | 日志查看数 |
| replynum | mediumint(8) unsigned |   | NO |   | 日志回复数 |
| hot | mediumint(8) unsigned |   | NO |   | 热度 |
| dateline | int(10) unsigned |   | NO |   | 日志发布时间 |
| picflag | tinyint(1) |   | NO |   | 日志是否有图片 |
| noreply | tinyint(1) |   | NO |   | 是否允许评论:"0"为允许,"1"为不允许 |
| friend | tinyint(1) |   | NO |   | 日志隐私设置:"0"为全站用户可见,"1"为全好友可见,"2"为仅指定的好友可见,"3"为仅自己可见,"4"为凭密码查看 |
| password | char(10) |   | NO |   | 日志密码 |
| favtimes | mediumint(8) unsigned |   | NO |   | 日志收藏次数 |
| sharetimes | mediumint(8) unsigned |   | NO |   | 日志分享次数 |
| status | tinyint(1) |   | NO |   | blog状态 -1:回收站日志; 0:正常; 1:审核; |
| click1 | smallint(6) unsigned |   | NO |   | 表态1 id |
| click2 | smallint(6) unsigned |   | NO |   | 表态2 id |
| click3 | smallint(6) unsigned |   | NO |   | 表态3 id |
| click4 | smallint(6) unsigned |   | NO |   | 表态4 id |
| click5 | smallint(6) unsigned |   | NO |   | 表态5 id |
| click6 | smallint(6) unsigned |   | NO |   | 表态6 id |
| click7 | smallint(6) unsigned |   | NO |   | 表态7 id |
| click8 | smallint(6) unsigned |   | NO |   | 表态8 id |
...
| upid | mediumint(8) unsigned |   | NO |   | 上级栏目id |
| catname | varchar(255) |   | NO |   | 标题 |
| num | mediumint(8) unsigned |   | NO |   | 日志数 |
| displayorder | smallint(6) |   | NO |   | 显示顺序 |
...
| 字段名 | 数据类型 | 默认值 | 允许非空 | 自动递增 | 备注 |
| ------ | -------- | ------ | -------- | -------- | ---- |
| blogid | mediumint(8) unsigned |   | NO |   | 日志id |
| uid | mediumint(8) unsigned |   | NO |   | 日志所属用户ID |
| pic | varchar(255) |   | NO |   | 标题图片 |
| tag | varchar(255) |   | NO |   | 日志TAG |
| message | mediumtext |   | NO |   | 日志内容 |
| postip | varchar(255) |   | NO |   | 发表日志的IP |
| related | text |   | NO |   | 相关日志的数据信息 |
| relatedtime | int(10) unsigned |   | NO |   | 相关日志产生时间戳 |
| target_ids | text |   | NO |   | 允许查看日志的用户ID多个ID以","间隔 |
| hotuser | text |   | NO |   | 热点用户 |
| magiccolor | tinyint(6) |   | NO |   | 道具彩色灯id |
| magicpaper | tinyint(6) |   | NO |   | 道具信纸id |
| pushedaid | mediumint(8) |   | NO |   | 被推送到的文章aid |
...
| 字段名 | 数据类型 | 默认值 | 允许非空 | 自动递增 | 备注 |
| ------ | -------- | ------ | -------- | -------- | ---- |
| classid | mediumint(8) unsigned |   | NO | 是 | 个人分类id |
| classname | char(40) |   | NO |   | 分类名称 |
| uid | mediumint(8) unsigned |   | NO |   | 分类所属用户ID |
| dateline | int(10) unsigned |   | NO |   | 分类创建时间戳 |

## pre_home_click  表态动作

| 字段名 | 数据类型 | 默认值 | 允许非空 | 自动递增 | 备注 |
| ------ | -------- | ------ | -------- | -------- | ---- |
| clickid | smallint(6) unsigned |   | NO | 是 | 表态ID |
| name | char(50) |   | NO |   | 表态名称 |
| icon | char(100) |   | NO |   | 表态图标 |
| idtype | char(15) |   | NO |   | 表态类型 |
| available | tinyint(1) unsigned |   | NO |   | 是否有效 |
| displayorder | tinyint(6) unsigned |   | NO |   | 排序 |

## pre_home_clickuser  用户表态表

| 字段名 | 数据类型 | 默认值 | 允许非空 | 自动递增 | 备注 |
| ------ | -------- | ------ | -------- | -------- | ---- |
| uid | mediumint(8) unsigned |   | NO |   | 表态用户id |
| username | varchar(15) |   | NO |   | 表态用户名 |
| id | mediumint(8) unsigned |   | NO |   | 作用对象id |
| idtype | varchar(15) |   | NO |   | 作用对象id类型 |
| clickid | smallint(6) unsigned |   | NO |   | 表态id |
| dateline | int(10) unsigned |   | NO |   | 发表表态时间戳 |
...
| ------ | -------- | ------ | -------- | -------- | ---- |
| cid | mediumint(8) unsigned |   | NO | 是 | 评论id |
| uid | mediumint(8) unsigned |   | NO |   | 发表评论的用户id |
| id | mediumint(8) unsigned |   | NO |   | 评论对象id |
| idtype | varchar(20) |   | NO |   | 评论对象的id类型：blogid，picid，uid |
| authorid | mediumint(8) unsigned |   | NO |   | 若为回复,回复作者用户ID |
| author | varchar(15) |   | NO |   | 若为回复,回复作者用户名 |
| ip | varchar(20) |   | NO |   | 评论IP |
| dateline | int(10) unsigned |   | NO |   | 评论时间戳 |
| message | text |   | NO |   | 评论内容 |
| magicflicker | tinyint(1) |   | NO |   | 是否使用了道具彩虹炫 |
| status | tinyint(1) |   | NO |   | 评论状态 1-审核 |
...
| 字段名 | 数据类型 | 默认值 | 允许非空 | 自动递增 | 备注 |
| ------ | -------- | ------ | -------- | -------- | ---- |
| id | int(10) unsigned |   | NO | 是 | 记录回复id |
| upid | int(10) unsigned |   | NO |   | 上级记录回复id |
| doid | mediumint(8) unsigned |   | NO |   | 所评论的记录id |
| uid | mediumint(8) unsigned |   | NO |   | 发布记录者用户id |
| username | varchar(15) |   | NO |   | 发布记录者用户名 |
| dateline | int(10) unsigned |   | NO |   | 记录回复时间戳 |
| message | text |   | NO |   | 记录回复内容 |
| ip | varchar(20) |   | NO |   | 发布记录ip |
| grade | smallint(6) unsigned |   | NO |   | 记录回复的层级 |

## pre_home_doing  用户记录表

| 字段名 | 数据类型 | 默认值 | 允许非空 | 自动递增 | 备注 |
| ------ | -------- | ------ | -------- | -------- | ---- |
| doid | mediumint(8) unsigned |   | NO | 是 | 记录id |
| uid | mediumint(8) unsigned |   | NO |   | 记录发布者用户id |
| username | varchar(15) |   | NO |   | 记录发布者用户名 |
| from | varchar(20) |   | NO |   | 记录的发表来源 |
| dateline | int(10) unsigned |   | NO |   | 记录发布时间戳 |
| message | text |   | NO |   | 记录内容 |
| ip | varchar(20) |   | NO |   | 记录发布ip |
| replynum | int(10) unsigned |   | NO |   | 记录回复数 |
| status | tinyint(1) unsigned |   | NO |   | 记录状态 1-审核 |
...
| idtype | varchar(255) |   | NO |   |   |
| spaceuid | mediumint(8) unsigned |   | NO |   | 空间会员id |
...
| 字段名 | 数据类型 | 默认值 | 允许非空 | 自动递增 | 备注 |
| ------ | -------- | ------ | -------- | -------- | ---- |
| feedid | int(10) unsigned |   | NO | 是 | feed的ID |
| appid | smallint(6) unsigned |   | NO |   | 应用程序ID |
| icon | varchar(30) |   | NO |   | feed图标 |
| uid | mediumint(8) unsigned |   | NO |   | 产生feed的用户ID |
| username | varchar(15) |   | NO |   | 产生feed的用户名 |
| dateline | int(10) unsigned |   | NO |   | feed产生时间戳 |
| friend | tinyint(1) |   | NO |   | 产生feed信息的隐私设置 |
| hash_template | varchar(32) |   | NO |   | 模板hash:md5(title_template"	"body_template) |
| hash_data | varchar(32) |   | NO |   | 数据内容hash:md5(title_templat"	"title_data"	"body_template"	"body_data) |
| title_template | text |   | NO |   | feed标题模板 |
| title_data | text |   | NO |   | feed标题 |
| body_template | text |   | NO |   | feed内容模板 |
| body_data | text |   | NO |   | feed内容 |
| body_general | text |   | NO |   | 用户填写的信息 |
| image_1 | varchar(255) |   | NO |   | feed图1 |
| image_1_link | varchar(255) |   | NO |   | feed图片链接1 |
| image_2 | varchar(255) |   | NO |   | feed图片2 |
| image_2_link | varchar(255) |   | NO |   | feed图片链接2 |
| image_3 | varchar(255) |   | NO |   | feed图片3 |
| image_3_link | varchar(255) |   | NO |   | feed图片链接3 |
| image_4 | varchar(255) |   | NO |   | feed图片4 |
| image_4_link | varchar(255) |   | NO |   | feed图片链接4 |
| target_ids | text |   | NO |   | 产生feed信息允许查看的好友ID |
| id | mediumint(8) unsigned |   | NO |   | feed对应对象id |
| idtype | varchar(15) |   | NO |   | feed对应对象类型 |
| hot | mediumint(8) unsigned |   | NO |   | 热度 |
...
| 字段名 | 数据类型 | 默认值 | 允许非空 | 自动递增 | 备注 |
| ------ | -------- | ------ | -------- | -------- | ---- |
| feedid | int(10) unsigned |   | NO | 是 | 应用feed id |
| appid | smallint(6) unsigned |   | NO |   | 应用程序ID |
| icon | varchar(30) |   | NO |   | feed图标 |
| uid | mediumint(8) unsigned |   | NO |   | 产生feed的用户ID |
| username | varchar(15) |   | NO |   | 产生feed的用户名 |
...
| uid | mediumint(8) unsigned |   | NO |   | 用户ID |
| username | char(15) |   | NO |   | 用户名 |
| followuid | mediumint(8) unsigned |   | NO |   | 被关注用户ID |
| fusername | char(15) |   | NO |   | 被关注用户名称 |
| bkname | varchar(255) |   | NO |   | 用户备注 |
| status | tinyint(1) |   | NO |   | 0:正常 1:特殊关注 -1:不能再关注此人 |
| mutual | tinyint(1) |   | NO |   | 0:单向 1:已互相关注 |
| dateline | int(10) unsigned |   | NO |   |   |
...
| 字段名 | 数据类型 | 默认值 | 允许非空 | 自动递增 | 备注 |
| ------ | -------- | ------ | -------- | -------- | ---- |
| feedid | mediumint(8) unsigned |   | NO | 是 | 自增id |
| uid | mediumint(8) unsigned |   | NO |   | 被关注者ID |
| username | varchar(15) |   | NO |   | 被关注用户名 |
| tid | mediumint(8) unsigned |   | NO |   | 帖子tid |
| note | text |   | NO |   | 转发理由 |
| dateline | int(10) unsigned |   | NO |   |   |
...
| ------ | -------- | ------ | -------- | -------- | ---- |
| uid | mediumint(8) unsigned |   | NO |   | 用户ID |
| fuid | mediumint(8) unsigned |   | NO |   | 用户好友ID |
| fusername | varchar(15) |   | NO |   | 用户好友名 |
| gid | smallint(6) unsigned |   | NO |   | 好友所在的好友组ID |
| num | mediumint(8) unsigned |   | NO |   | 好友之间的任务关系数 |
| dateline | int(10) unsigned |   | NO |   | 加好友的时间戳 |
| note | varchar(255) |   | NO |   | 好友备注 |
...
| ------ | -------- | ------ | -------- | -------- | ---- |
| uid | mediumint(8) unsigned |   | NO |   | 用户ID |
| fuid | mediumint(8) unsigned |   | NO |   | 被请求用户ID |
| fusername | char(15) |   | NO |   | 被请求用户名称 |
| gid | smallint(6) unsigned |   | NO |   | 好友所在的好友组ID |
| note | char(60) |   | NO |   | 申请附言 |
| dateline | int(10) unsigned |   | NO |   | 请求好友时间戳 |
...
| ------ | -------- | ------ | -------- | -------- | ---- |
| uid | mediumint(8) unsigned |   | NO |   | 用户ID |
| fuid | mediumint(8) unsigned |   | NO |   | 好友用户ID |
| action | varchar(10) |   | NO |   | 好友动作:"add"添加,"update"更新 |
| dateline | int(10) unsigned |   | NO |   | 好友动作时间 |

## pre_home_notification  通知表

| 字段名 | 数据类型 | 默认值 | 允许非空 | 自动递增 | 备注 |
| ------ | -------- | ------ | -------- | -------- | ---- |
| id | mediumint(8) unsigned |   | NO | 是 | 通知ID |
| uid | mediumint(8) unsigned |   | NO |   | 通知用户ID |
| type | varchar(20) |   | NO |   | 通知类型:"doing"记录,"friend"好友请求,"sharenotice"好友分享,"post"话题回复, |
| new | tinyint(1) |   | NO |   | 通知是否为新:"1"为新通知,"0"为通知已读 |
| authorid | mediumint(8) unsigned |   | NO |   | 作者用户ID |
| author | varchar(15) |   | NO |   | 用户名 |
| note | text |   | NO |   | 通知内容 |
| dateline | int(10) unsigned |   | NO |   | 通知产生的时间戳 |
| from_id | mediumint(8) unsigned |   | NO |   | 来源对象id |
| from_idtype | varchar(20) |   | NO |   | 来源对象类型 |
| from_num | mediumint(8) unsigned |   | NO |   | 来源量 |
| category | tinyint(1) |   | NO |   | 提醒分类 1我的帖子 2坛友互动 3系统消息 4管理工作 0应用消息 |

## pre_home_pic  家园图片表

| 字段名 | 数据类型 | 默认值 | 允许非空 | 自动递增 | 备注 |
| ------ | -------- | ------ | -------- | -------- | ---- |
| picid | mediumint(8) |   | NO | 是 | 图片ID |
| albumid | mediumint(8) unsigned |   | NO |   | 图片所属相册ID |
| uid | mediumint(8) unsigned |   | NO |   | 图片所属用户ID |
| username | varchar(15) |   | NO |   | 图片所属用户名 |
| dateline | int(10) unsigned |   | NO |   | 图片上传时间戳 |
| postip | varchar(255) |   | NO |   | 图片上传ip |
| filename | varchar(255) |   | NO |   | 图片文件名 |
| title | varchar(255) |   | NO |   | 图片标题 |
| type | varchar(255) |   | NO |   | 图片类型 |
| size | int(10) unsigned |   | NO |   | 图片大小 |
| filepath | varchar(255) |   | NO |   | 图片路径 |
| thumb | tinyint(1) |   | NO |   | 是否有缩略图 |
| remote | tinyint(1) |   | NO |   | 是否有远程图片0:home本地图片,1:home远程图片,2:论坛本地图片,3论坛远程图片 |
| hot | mediumint(8) unsigned |   | NO |   | 热度 |
| sharetimes | mediumint(8) unsigned |   | NO |   | 图片分享次数 |
| click1 | smallint(6) unsigned |   | NO |   | 表态1 id |
| click2 | smallint(6) unsigned |   | NO |   | 表态2 id |
| click3 | smallint(6) unsigned |   | NO |   | 表态3 id |
| click4 | smallint(6) unsigned |   | NO |   | 表态4 id |
...
| click7 | smallint(6) unsigned |   | NO |   | 表态7 id |
| click8 | smallint(6) unsigned |   | NO |   | 表态8 id |
| magicframe | tinyint(6) |   | NO |   | 道具使用相框id |
| status | tinyint(1) unsigned |   | NO |   | 图片状态 1-审核 |
...
| 字段名 | 数据类型 | 默认值 | 允许非空 | 自动递增 | 备注 |
| ------ | -------- | ------ | -------- | -------- | ---- |
| picid | mediumint(8) unsigned |   | NO |   | 图片id |
| hotuser | text |   | NO |   | 图片对应热点用户 |

## pre_home_poke  用户招呼表

| 字段名 | 数据类型 | 默认值 | 允许非空 | 自动递增 | 备注 |
| ------ | -------- | ------ | -------- | -------- | ---- |
| uid | mediumint(8) unsigned |   | NO |   | 接招呼的用户ID |
| fromuid | mediumint(8) unsigned |   | NO |   | 打招呼的用户ID |
| fromusername | varchar(15) |   | NO |   | 打招呼的用户名 |
| note | varchar(255) |   | NO |   | 招呼内容 |
| dateline | int(10) unsigned |   | NO |   | 打招呼时间戳 |
| iconid | smallint(6) unsigned |   | NO |   | 招呼图标 |

## pre_home_pokearchive  用户招呼存档表

| 字段名 | 数据类型 | 默认值 | 允许非空 | 自动递增 | 备注 |
| ------ | -------- | ------ | -------- | -------- | ---- |
| pid | mediumint(8) |   | NO | 是 | 招呼历史id |
| pokeuid | int(10) unsigned |   | NO |   | uid + fromuid |
| uid | mediumint(8) unsigned |   | NO |   | 目标用户ID |
| fromuid | mediumint(8) unsigned |   | NO |   | 发起用户ID |
| note | varchar(255) |   | NO |   | 招呼内容 |
| dateline | int(10) unsigned |   | NO |   | 招呼时间戳 |
| iconid | smallint(6) unsigned |   | NO |   | 招呼图标 |
...
| 字段名 | 数据类型 | 默认值 | 允许非空 | 自动递增 | 备注 |
| ------ | -------- | ------ | -------- | -------- | ---- |
| sid | mediumint(8) unsigned |   | NO | 是 | 分享id |
| itemid | mediumint(8) unsigned |   | NO |   | 相关条目的ID |
| type | varchar(30) |   | NO |   | 分享类型 |
| uid | mediumint(8) unsigned |   | NO |   | 分享者用户id |
| username | varchar(15) |   | NO |   | 分享者用户名 |
| fromuid | mediumint(8) unsigned |   | NO |   | 被分享者用户ID |
| dateline | int(10) unsigned |   | NO |   | 分享时间戳 |
| title_template | text |   | NO |   | 分享标题模板 |
| body_template | text |   | NO |   | 分享内容模板 |
| body_data | text |   | NO |   | 分享内容数据 |
| body_general | text |   | NO |   | 分享说明 |
| image | varchar(255) |   | NO |   | 分享的图片 |
| image_link | varchar(255) |   | NO |   | 分享的图片链接 |
| hot | mediumint(8) unsigned |   | NO |   | 热度 |
| hotuser | text |   | NO |   | 相关热点用户 |
| status | tinyint(1) |   | NO |   | 分享条目状态 1-审核 |
...
| 字段名 | 数据类型 | 默认值 | 允许非空 | 自动递增 | 备注 |
| ------ | -------- | ------ | -------- | -------- | ---- |
| uid | mediumint(8) unsigned |   | NO |   | 我要上榜用户id |
| username | varchar(15) |   | NO |   | 我要上榜用户名 |
| unitprice | int(10) unsigned | 1 | NO |   | 单次访问单价 |
| credit | int(10) unsigned |   | NO |   | 上榜总积分 |
| note | varchar(100) |   | NO |   | 上榜宣言 |
...
| uid | mediumint(8) unsigned |   | NO |   | 用户ID |
| username | varchar(15) |   | NO |   | 用户名 |
| status | tinyint(1) unsigned |   | NO |   | 用户类型0为推荐用户1为默认好友 |
| dateline | int(10) |   | NO |   | 设置时间 |
| reason | text |   | NO |   | 操作原因 |
| opuid | mediumint(8) unsigned |   | NO |   | 操作者用户ID |
| opusername | varchar(15) |   | NO |   | 操作者用户名 |
| displayorder | mediumint(8) unsigned |   | NO |   | 显示顺序 |

## pre_home_userapp  用户使用应用表

| 字段名 | 数据类型 | 默认值 | 允许非空 | 自动递增 | 备注 |
| ------ | -------- | ------ | -------- | -------- | ---- |
| uid | mediumint(8) unsigned |   | NO |   | 使用应用的用户ID |
| appid | mediumint(8) unsigned |   | NO |   | 应用ID |
| appname | varchar(60) |   | NO |   | 应用名 |
| privacy | tinyint(1) |   | NO |   | 应用是否公开 |
| allowsidenav | tinyint(1) |   | NO |   | 是否在开始菜单中显示 |
| allowfeed | tinyint(1) |   | NO |   | 是否允许应用产生feed |
| allowprofilelink | tinyint(1) |   | NO |   | 时都允许在首页显示连接 |
| narrow | tinyint(1) |   | NO |   | 是否在个人空间左边显示 |
| menuorder | smallint(6) |   | NO |   | 菜单顺序 |
| displayorder | smallint(6) |   | NO |   | 显示顺序 |
...
| uid | mediumint(8) unsigned |   | NO |   | 使用应用的用户id |
| appid | mediumint(8) unsigned |   | NO |   | 应用id |
| profilelink | text |   | NO |   | 应用链接 |
| myml | text |   | NO |   | myml格式的首页显示信息 |

## pre_home_visitor  空间访问日志表

| 字段名 | 数据类型 | 默认值 | 允许非空 | 自动递增 | 备注 |
| ------ | -------- | ------ | -------- | -------- | ---- |
| uid | mediumint(8) unsigned |   | NO |   | 受访者用户id |
| vuid | mediumint(8) unsigned |   | NO |   | 访问者用户id |
| vusername | char(15) |   | NO |   | 访问者用户名 |
| dateline | int(10) unsigned |   | NO |   | 访问时间戳 |

## pre_portal_article_content  门户文章内容表

| 字段名 | 数据类型 | 默认值 | 允许非空 | 自动递增 | 备注 |
| ------ | -------- | ------ | -------- | -------- | ---- |
| cid | int(10) unsigned |   | NO | 是 | 内容ID |
| aid | mediumint(8) unsigned |   | NO |   | 文章ID |
| id | int(10) unsigned |   | NO |   | 来源ID |
| idtype | varchar(255) |   | NO |   | 来源ID类型 |
| title | varchar(255) |   | NO |   | 分页标题 |
| content | text |   | NO |   | 文章内容 |
| pageorder | smallint(6) unsigned |   | NO |   | 分页排序 |
| dateline | int(10) unsigned |   | NO |   | 添加时间 |
...
| ------ | -------- | ------ | -------- | -------- | ---- |
| aid | mediumint(8) unsigned |   | NO |   | 文章ID |
| catid | mediumint(8) unsigned |   | NO |   | 栏目id |
| viewnum | mediumint(8) unsigned |   | NO |   | 查看数 |
| commentnum | mediumint(8) unsigned |   | NO |   | 评论数 |
| favtimes | mediumint(8) unsigned |   | NO |   | 文章收藏次数 |
| sharetimes | mediumint(8) unsigned |   | NO |   | 文章分享次数 |
...
| 字段名 | 数据类型 | 默认值 | 允许非空 | 自动递增 | 备注 |
| ------ | -------- | ------ | -------- | -------- | ---- |
| aid | mediumint(8) unsigned |   | NO | 是 | 文章ID |
| raid | mediumint(8) unsigned |   | NO |   | 相关文章ID |
| displayorder | mediumint(8) unsigned |   | NO |   | 显示顺序 |
...
| username | varchar(255) |   | NO |   | 用户名 |
| title | varchar(255) |   | NO |   | 标题 |
| highlight | varchar(255) |   | NO |   | 标题样式 |
| author | varchar(255) |   | NO |   | 原作者 |
| from | varchar(255) |   | NO |   | 来源 |
| fromurl | varchar(255) |   | NO |   | 来源URL |
| url | varchar(255) |   | NO |   | 访问URL |
| summary | varchar(255) |   | NO |   | 摘要 |
| pic | varchar(255) |   | NO |   | 封面图片 |
| thumb | tinyint(1) |   | NO |   | 封面图片是否缩略 |
| remote | tinyint(1) |   | NO |   | 封面图片是否远程 |
| id | int(10) unsigned |   | NO |   | 来源ID |
| idtype | varchar(255) |   | NO |   | 来源ID类型 |
| contents | smallint(6) |   | NO |   | 内容分页数 |
| allowcomment | tinyint(1) |   | NO |   | 是否允许评论 |
| owncomment | tinyint(1) |   | NO |   | 对于推送过来的文章：1，使用文章评论；0，同步原主题/日志的帖子/评论 |
| click1 | smallint(6) unsigned |   | NO |   | 表态1 id |
| click2 | smallint(6) unsigned |   | NO |   | 表态2 id |
| click3 | smallint(6) unsigned |   | NO |   | 表态3 id |
| click4 | smallint(6) unsigned |   | NO |   | 表态4 id |
...
| click7 | smallint(6) unsigned |   | NO |   | 表态7 id |
| click8 | smallint(6) unsigned |   | NO |   | 表态8 id |
| tag | tinyint(8) unsigned |   | NO |   | 文章属性，共八位 |
| dateline | int(10) unsigned |   | NO |   | 添加时间 |
| status | tinyint(1) unsigned |   | NO |   | 文章状态 0-已审核 1-需要审核 2-已忽略 |
| showinnernav | tinyint(1) unsigned |   | NO |   | 是否显示分页导航 |
| preaid | mediumint(8) unsigned |   | NO |   | 上一篇文章ID |
| nextaid | mediumint(8) unsigned |   | NO |   | 下一篇文章ID |
| htmlmade | tinyint(1) unsigned |   | NO |   | 是否生成静态文件 |
| htmlname | varchar(255) |   | NO |   | 静态文件名称 |
| htmldir | varchar(255) |   | NO |   | 静态文件目录 |

## pre_portal_article_trash  门户文章回收站表

| 字段名 | 数据类型 | 默认值 | 允许非空 | 自动递增 | 备注 |
| ------ | -------- | ------ | -------- | -------- | ---- |
| aid | mediumint(8) unsigned |   | NO |   | 垃圾文章ID |
| content | text |   | NO |   | 文章数据的seriallize存储 |

## pre_portal_attachment  门户文章附件表

| 字段名 | 数据类型 | 默认值 | 允许非空 | 自动递增 | 备注 |
| ------ | -------- | ------ | -------- | -------- | ---- |
| attachid | mediumint(8) unsigned |   | NO | 是 | 附件id |
| uid | mediumint(8) unsigned |   | NO |   | 会员id |
| dateline | int(10) unsigned |   | NO |   | 上传时间 |
| filename | varchar(255) |   | NO |   | 原文件名 |
| filetype | varchar(255) |   | NO |   | 文件类型 |
| filesize | int(10) unsigned |   | NO |   | 文件大小 |
| attachment | varchar(255) |   | NO |   | 服务器路径 |
| isimage | tinyint(1) |   | NO |   | 是否图片 |
| thumb | tinyint(1) unsigned |   | NO |   | 是否是缩率图 |
...
| upid | mediumint(8) unsigned |   | NO |   | 上级栏目id |
| catname | varchar(255) |   | NO |   | 标题 |
| articles | mediumint(8) unsigned |   | NO |   | 文章数 |
| allowcomment | tinyint(1) | 1 | NO |   | 是否允许评论 |
| displayorder | smallint(6) |   | NO |   | 显示顺序 |
| notinheritedarticle | tinyint(1) |   | NO |   | 是否不继承上级文章管理权限 |
| notinheritedblock | tinyint(1) |   | NO |   | 是否不继承上级DIY页面和模块权限 |
| domain | varchar(255) |   | NO |   | 二级域名 |
| url | varchar(255) |   | NO |   | 自定义链接 |
| uid | mediumint(8) unsigned |   | NO |   | 创建者ID |
| username | varchar(255) |   | NO |   | 创建者用户名 |
| dateline | int(10) unsigned |   | NO |   | 创建时间 |
| closed | tinyint(1) |   | NO |   | 是否关闭 |
| shownav | tinyint(1) |   | NO |   | 是否在导航显示 |
| description | text |   | NO |   | 分类介绍 SEO描述 |
| seotitle | text |   | NO |   | SEO 标题 |
| keyword | text |   | NO |   | SEO 关键字 |
| primaltplname | varchar(255) |   | NO |   | 列表页原模板地址 |
| articleprimaltplname | varchar(255) |   | NO |   | 文章页原模板地址 |
| disallowpublish | tinyint(1) |   | NO |   | 是否禁止发布文章 |
| foldername | varchar(255) |   | NO |   | 文件夹名称 |
| notshowarticlesummay | varchar(255) |   | NO |   | 文章内容页是否不显示摘要 |
| perpage | smallint(6) |   | NO |   | 列表每页显示文章数 |
| maxpages | smallint(6) |   | NO |   | 列表最大分页数 |
| noantitheft | tinyint(1) |   | NO |   | 禁止防采集 |
| lastpublish | int(10) unsigned |   | NO |   | 最后发布文章时间 |

## pre_portal_category_permission  文章分类权限表

| 字段名 | 数据类型 | 默认值 | 允许非空 | 自动递增 | 备注 |
| ------ | -------- | ------ | -------- | -------- | ---- |
| catid | mediumint(8) unsigned |   | NO |   | 分类ID |
| uid | mediumint(8) unsigned |   | NO |   | 会员id |
| allowpublish | tinyint(1) |   | NO |   | 允许发布文章 |
| allowmanage | tinyint(1) |   | NO |   | 允许管理文章 |
| inheritedcatid | mediumint(8) |   | NO |   | 继承自的频道ID |
...
| cid | mediumint(8) unsigned |   | NO | 是 | 评论id |
| uid | mediumint(8) unsigned |   | NO |   | 发表评论的用户id |
| username | varchar(255) |   | NO |   | 发表评论的用户名 |
| id | mediumint(8) unsigned |   | NO |   | 评论对象id |
| idtype | varchar(20) |   | NO |   | 评论对象的id类型：aid，topicid |
| postip | varchar(255) |   | NO |   | 评论IP |
| dateline | int(10) unsigned |   | NO |   | 评论时间戳 |
| status | tinyint(1) unsigned |   | NO |   | 评论状态 1-审核 |
| message | text |   | NO |   | 评论内容 |
...
| ------ | -------- | ------ | -------- | -------- | ---- |
| lastupdate | int(10) unsigned |   | NO |   | 最后更新时间 |
| catid | mediumint(8) unsigned |   | NO |   | 文章分类id |
| aid | mediumint(8) unsigned |   | NO |   | 文章id |
| dateline | int(10) unsigned |   | NO |   | 发表时间 |
| catname | char(50) |   | NO |   | 分类名称 |
| author | char(15) |   | NO |   | 作者 |
| subject | char(80) |   | NO |   | 标题 |
| description | char(255) |   | NO |   | 解释说明 |
...
| 字段名 | 数据类型 | 默认值 | 允许非空 | 自动递增 | 备注 |
| ------ | -------- | ------ | -------- | -------- | ---- |
| topicid | mediumint(8) unsigned |   | NO | 是 | 专题ID |
| title | varchar(255) |   | NO |   | 专题标题 |
| name | varchar(255) |   | NO |   | 静态化名称 |
| domain | varchar(255) |   | NO |   | 二级域名 |
| summary | text |   | NO |   | 专题介绍 |
| keyword | text |   | NO |   | SEO 关键字 |
| cover | varchar(255) |   | NO |   | 专题封面 |
| picflag | tinyint(1) |   | NO |   | 图片类型 0为url 1为本地 2 为ftp远程 |
| primaltplname | varchar(255) |   | NO |   | 原模板地址 |
| useheader | tinyint(1) |   | NO |   | 是否使用网站导航内容 |
| usefooter | tinyint(1) |   | NO |   | 是否使用网站尾部信息 |
| uid | mediumint(8) unsigned |   | NO |   | 创建者UID |
| username | varchar(255) |   | NO |   | 创建者用户名 |
| viewnum | mediumint(8) unsigned |   | NO |   | 查看数 |
| dateline | int(10) unsigned |   | NO |   | 创建时间 |
| closed | tinyint(1) |   | NO |   | 是否关闭状态 |
| allowcomment | tinyint(1) |   | NO |   | 是否允许评论 |
| commentnum | mediumint(8) unsigned |   | NO |   | 评论数 |
| htmlmade | tinyint(1) unsigned |   | NO |   | 是否生成静态文件 |
| htmldir | varchar(255) |   | NO |   | 静态文件目录 |
...
| ------ | -------- | ------ | -------- | -------- | ---- |
| picid | mediumint(8) |   | NO | 是 | 图片ID |
| topicid | mediumint(8) unsigned |   | NO |   | 图片所属专题ID |
| uid | mediumint(8) unsigned |   | NO |   | 图片所属用户ID |
| username | varchar(15) |   | NO |   | 图片所属用户名 |
| dateline | int(10) unsigned |   | NO |   | 图片上传时间戳 |
| filename | varchar(255) |   | NO |   | 图片文件名 |
